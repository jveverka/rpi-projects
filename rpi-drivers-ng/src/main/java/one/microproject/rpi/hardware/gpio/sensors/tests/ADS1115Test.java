...
public class ADS1115Test {
    ...
    public static void test(Context context) throws Exception {
        ...
        try (ADS1115 ads1115 = new ADS1115(context)) {
            for (int i = 0; i < 10; i++) {
                double aIn0 = ads1115.readAIn0();
                double aIn1 = ads1115.readAIn1();
                double aIn2 = ads1115.readAIn2();
                double aIn3 = ads1115.readAIn3();
