...
```
# on x86 AMD64 device:
docker build -t jurajveverka/device-controller:1.4.5-amd64 --build-arg ARCH=amd64 --file ./device-controller/Dockerfile ./device-controller 
docker push jurajveverka/device-controller:1.4.5-amd64

# on ARM64 v8 device:
docker build -t jurajveverka/device-controller:1.4.5-arm64v8 --build-arg ARCH=arm64v8 --file ./device-controller/Dockerfile ./device-controller 
docker push jurajveverka/device-controller:1.4.5-arm64v8

# on x86 AMD64 device: 
docker manifest create \
jurajveverka/device-controller:1.4.5 \
--amend jurajveverka/device-controller:1.4.5-amd64 \
--amend jurajveverka/device-controller:1.4.5-arm64v8

docker manifest push jurajveverka/device-controller:1.4.5
```